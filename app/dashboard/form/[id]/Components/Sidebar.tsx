...
const Sidebar: React.FC<SidebarProps> = ({ setFieldValue, data }) => {
  ...
  const profileImage1 = data.profile ? supabaseBaseUrl + data.profile : '/utilits/img/player1.png';
  const logoImage1 = data.logo ? supabaseBaseUrl + data.logo : '/utilits/img/clublogo.png';
  ...
  useEffect(() => {
    console.log("Profile value in edit:", data.profile);
    console.log("Logo value in edit:", data.logo);
    setProfileImage(data.profile ? supabaseBaseUrl + data.profile : '/utilits/img/player1.png');
    setLogoImage(data.logo ? supabaseBaseUrl + data.logo : '/utilits/img/clublogo.png');
  }, [data.profile, data.logo]);
